...
import rootfs_base_man_mount_dsmd from "./rootfs/base/man/mount.dsmd";
...
export function buildrootfs(): DSFileSystem {
    ...
    // Creating rootfs/base/man/mount.dsmd
    curfile = new DSIWebFile(fs, rootfs_base_man_mount_dsmd);
    ...
    curdir.chmod(DSFilePerms.rx());
    curdir = dirstack.pop();
    // Exited rootfs/site/data/app/fsviewer
